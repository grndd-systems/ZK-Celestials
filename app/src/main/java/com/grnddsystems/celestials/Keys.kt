...
object Keys {
    const val lightVerificationSKHex = "dummy_verification_key"
    const val GOOGLE_WEB_KEY = "dummy_google_key"
    const val APP_ID = "com.grnddsystems.celestials"
    const val APPSFLYER_DEV_KEY = "dummy_appsflyer_key"
