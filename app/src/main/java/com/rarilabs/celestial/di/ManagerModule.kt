...
import com.rarilabs.celestial.api.auth.AuthAPI
import com.rarilabs.celestial.api.auth.AuthAPIManager
import com.rarilabs.celestial.api.auth.RefreshTokenInterceptor
import com.rarilabs.celestial.api.erc20.Erc20API
import com.rarilabs.celestial.api.erc20.Erc20ApiManager
import com.rarilabs.celestial.api.ext_integrator.ExtIntegratorAPI
import com.rarilabs.celestial.api.ext_integrator.ExtIntegratorApiManager
import com.rarilabs.celestial.api.hiddenPrize.HiddenPrizeApi
import com.rarilabs.celestial.api.hiddenPrize.HiddenPrizeApiManager
import com.rarilabs.celestial.api.hiddenPrize.models.Included
import com.rarilabs.celestial.api.hiddenPrize.models.IncludedJsonAdapter
import com.rarilabs.celestial.api.likeness.LikenessApi
import com.rarilabs.celestial.api.likeness.LikenessApiManager
import com.rarilabs.celestial.api.nativeToken.NativeTokenAPI
import com.rarilabs.celestial.api.nativeToken.models.NativeTokenAPIManager
import com.rarilabs.celestial.api.points.PointsAPI
import com.rarilabs.celestial.api.points.PointsAPIManager
import com.rarilabs.celestial.api.registration.RegistrationAPI
import com.rarilabs.celestial.api.registration.RegistrationAPIManager
import com.rarilabs.celestial.api.voting.VotingApi
import com.rarilabs.celestial.api.voting.VotingApiManager
import com.rarilabs.celestial.manager.AuthManager
import com.rarilabs.celestial.manager.DriveBackupManager
import com.rarilabs.celestial.manager.Erc20Manager
import com.rarilabs.celestial.manager.IdentityManager
import com.rarilabs.celestial.manager.NfcManager
...
import com.rarilabs.celestial.manager.RarimoContractManager
...
import com.rarilabs.celestial.manager.StableCoinContractManager
import com.rarilabs.celestial.manager.TestContractManager
...
import com.rarilabs.celestial.modules.webrtc.WebRTCProofCoordinator
import com.rarilabs.celestial.store.SecureSharedPrefsManager
import com.rarilabs.celestial.store.SecureSharedPrefsManagerImpl
import com.rarilabs.celestial.store.room.notifications.AppDatabase
import com.rarilabs.celestial.store.room.notifications.NotificationsDao
import com.rarilabs.celestial.store.room.notifications.NotificationsRepository
import com.rarilabs.celestial.store.room.transactons.TransactionDao
import com.rarilabs.celestial.store.room.voting.VotingDao
import com.rarilabs.celestial.store.room.voting.VotingRepository
