...
import com.rarilabs.celestial.modules.qr.QrProofProgressSheet
...
import com.rarilabs.celestial.ui.components.UiSnackbarDefault
import com.rarilabs.celestial.ui.components.enter_program.EnterProgramFlow
import com.rarilabs.celestial.ui.components.enter_program.UNSPECIFIED_PASSPORT_STEPS
...
import com.rarilabs.celestial.util.QrProofNotificationHelper
...
fun MainScreenContent(
    ...
    AppTheme(colorScheme = colorSchema) {
        Scaffold(
            ...
            // QR Proof Progress Bottom Sheet with Notification Support
            ...
            AppBottomSheet(
                ...
                // Track app lifecycle for background notifications
                androidx.compose.runtime.DisposableEffect(lifecycleOwner) {
                    val observer = androidx.lifecycle.LifecycleEventObserver { _, event ->
                        when (event) {
                            androidx.lifecycle.Lifecycle.Event.ON_PAUSE -> {
                                // App goes to background - show notification if proof is in progress
                                if (qrProofProgressState.showSheet) {
                                    com.rarilabs.celestial.util.QrProofNotificationHelper.showProofInProgressNotification(context)
                                }
                            }
                            androidx.lifecycle.Lifecycle.Event.ON_RESUME -> {
                                // App returns to foreground - cancel notification
                                com.rarilabs.celestial.util.QrProofNotificationHelper.cancelNotification(context)
                            }
                            else -> {}
                        }
                    }
                    ...
                    onDispose {
                        ...
                        // Cancel notification when sheet is closed
                        com.rarilabs.celestial.util.QrProofNotificationHelper.cancelNotification(context)
                    }
                }
